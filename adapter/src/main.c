 ...
 * Main entry point
 * 
 * v0.5 - Automatic Bluetooth MAC configuration
 * 
 * Architecture:
...
int main(int argc, char* argv[]) {
    ...
    printf("  \n");
    printf("  Motion controls: Will auto-connect via Bluetooth when PS3\n");
    printf("                   reads Report 0xF5 (contains Pi's BT MAC)\n");
    printf("═══════════════════════════════════════════════════════════════\n");
    printf("\n");
    fflush(stdout);
